...
public class EnumMain {
	public static void main(String[] args) {
		...
		//JVM이 각 상수르르 단 한번만 생성하고 공유한다.
		
		Item i1 = Item.START;
		System.out.println(i1);
		//모든 열거형이 상속하는 Enum클래스에 toString() 메서드에서 이름을 반환하기 때문에 이름이 출력된다.
		...
		//열거형 상수에 들어있는 순서 보기
		for(Item item : items) {
			System.out.println("name = " + item.name()+", ordianl ="+item.ordinal());
...
//		int color = 999999; //문법적으로 틀린건 아니라서 에러는 안남.
		Color color = Color.RED; // Color타입만 들어올 수 있따.
	}
}
