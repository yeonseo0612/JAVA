...
public class Ex03_String {
	public static void main(String[] args) {
		...
		//문자열의 길이를 반환하는 메서드
			...
			//indexOf(char ch)
			//인자로 전달ㄷ뢴 글자의 인덱스 값을 반환한다.
			//왼쪽부터 오른쪽으로 탐색하고
			//같은 글자가 여러개 있을 때 가장 먼저 만나는 글자의 index값을 반환한다.
			...
			//substring(int offset, int end)
			//일정 인덱스만큼 글자를 잘라서 반환
			System.out.println(str.substring(0,5));
			
			//split()
			//인자로 전달되는 값을 구분자로 문자열을 분할하여 배열형태로 전환
